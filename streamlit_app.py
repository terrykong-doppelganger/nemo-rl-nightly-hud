...
st.caption(
    "Nightly CI HUD for commits in [NVIDIA-NeMo/RL](https://github.com/NVIDIA-NeMo/RL). This dashboard is under active development. **Test data is synthetic.** To expand and see all tests that failed on a particular day, go to Advanced settings and increase the 'Point jitter amplitude' option."
)
